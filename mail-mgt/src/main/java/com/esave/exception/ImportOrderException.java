...
public class ImportOrderException extends WebDriverException {
	 ...
	 * @param reasonCd
	 */
	public ImportOrderException(String detailedMsg, Integer reasonCd) {
		super(detailedMsg);
	 ...
	 * @param reasonCd
	 */
	public ImportOrderException(String detailedMsg, Throwable t, Integer reasonCd) {
		super(detailedMsg, t);
		this.reasonCode = reasonCd;
	}
	
	public ImportOrderException(String detailedMsg, Integer reasonCd, String purveyorId, String orderId) {
		super(detailedMsg);
		this.reasonCode = reasonCd;
	}
